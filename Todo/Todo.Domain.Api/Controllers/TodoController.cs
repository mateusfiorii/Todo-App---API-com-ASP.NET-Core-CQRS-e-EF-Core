...
namespace Todo.Api.Controllers
{
    ...
    public class TodoController : ControllerBase
    {
        ...
        {
            return repository.GetAll("mateusfiori");
        }
        ...
        {
            return repository.GetAllDone("mateusfiori");
        }
        ...
        {
            return repository.GetAllUndone("mateusfiori");
        }
        ...
        {
            return repository.GetByPeriod("mateusfiori", DateTime.Now.Date, true);
        }
        ...
        {
            return repository.GetByPeriod("mateusfiori", DateTime.Now.Date, false);
        }
        ...
        {
            return repository.GetByPeriod("mateusfiori", DateTime.Now.Date.AddDays(1), true);
        }
        ...
        {
            return repository.GetByPeriod("mateusfiori", DateTime.Now.Date.AddDays(1), false);
        }
        ...
        [Route("mark-as-done")]
        [HttpPut]
        public GenericCommandResult MaskAsDone([FromBody] MarkTodoAsDoneCommand command, [FromServices] TodoHandler handler)
        {
            command.User = "mateusfiori";
            return (GenericCommandResult)handler.Handle(command);
        }
